...
$reponse = $bdd->query("SELECT * FROM Station  where nom_station='$ville_dep'");
            ...
            <tr>
                ...
                <td>
                    ...
                    while ($donnees3 = $reponse3->fetch()) {
                        ?>
                        <?php echo ((int)($donnees3['heure_passage']/3600)); ?>h<?php echo (($donnees3['heure_passage']/3600 - (int)($donnees3['heure_passage']/3600))*60); ?>min <br /><?php } ?>
                </td>
                <td>
                    <?php $reponse3 = $bdd->query("SELECT * FROM Troncon inner join Transport_Troncon on Transport_Troncon.id_troncon=Troncon.id_troncon inner join Station on Troncon.station_dep=id_station where nom_station='$ville_dep' and nom_troncon='$test' and heure_passage/3600>=$heure_dep and heure_passage/3600<=$heure_max");
                    while ($donnees3 = $reponse3->fetch()) {
                        ...
                        <?php echo (int)(($donnees3['heure_passage']+$donnees3['duree'])/3600); ?>h<?php echo ((($donnees3['heure_passage']+$donnees3['duree'])/3600 - (int)(($donnees3['heure_passage']+$donnees3['duree'])/3600))*60); ?>min <br /><?php } ?>
                </td>
            </tr>
            </tbody>
        </table>
