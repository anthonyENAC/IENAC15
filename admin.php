...
<div id="accordion">
    ...
    <div>
        <p><form method="post" action="submit.php">
    ...
    <h3>Ajouter/Supprimer un mode de transport</h3>
    <div>
        <p>
        <form id="ajout_mode_type" method="post" action="submit.php">
            Ajouter un type de mode de transport :</br>
            <label>Nom</label>
    ...
    <h3>Ajouter/Supprimer une station</h3>
    <div>
        <p>
    ...
    <h3>Ajouter/Supprimer un transport pour un tronçon</h3>
    <div>
        <p>
        <form method="post" action="submit.php">
            <div id="ajout_transp_troncon" class="center">
                Ajouter un nouveau transport pour un tronçon :</br>
                <label>Durée (s)</label>
    ...
    <h3>Ajouter/Supprimer un tronçon</h3>
    <div>
        <p>
